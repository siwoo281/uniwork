const translations = {
    ko: {
        ...
        // F-Killer (Attendance Calculator)
        fk_title: "F-Killer",
        fk_subtitle: "F학점까지 몇번 남았을까? (배재대 전용)",
        fk_course_info: "📚 수업 정보",
        fk_credits_label: "이 수업, 몇 학점인가요?",
        fk_freq_label: "일주일에 몇 번 가나요?",
        fk_freq_note: "※ 3학점 주 2회 선택 시, 자동으로 75분(1.5시수)으로 계산됩니다.",
        fk_attendance_status: "📊 내 출석 현황",
        fk_absent_label: "결석 (수업 전체를 빠진 날)",
        fk_late_label: "지각/조퇴 횟수 (3회 = 1회 결석)",
        fk_excused_label: "공결/출석인정 횟수",
        fk_excused_note: "* 증빙서류 제출 시 결석에서 차감됩니다.",
        fk_rules_toggle: "[규정 보기]",
        fk_rules_close: "[규정 접기]",
        fk_calc_button: "💡 F 위험도 계산하기",
        fk_disclaimer: "본 계산기는 학칙 시행세칙을 기준으로 계산됩니다.\n반드시 '헤이영' 또는 '통합정보시스템'을 크로스 체크하세요.",
        fk_alert_select: "⚠️ 학점과 수업 횟수를 모두 선택해주세요!",
        fk_result_f_confirmed: "🚨 F 학점 확정 (재수강 요망)",
        fk_result_warning: "⚠️ 벼랑 끝! 더 이상 결석하면 F",
        fk_result_safe: "✅ 아직 안전합니다",
        fk_retake_rules: "ℹ️ 재수강 관련 규정",
    },
    en: {
        landing_title: "Your Dream at\nPai Chai University",
        landing_desc: "'Can I work with my visa?',\n'Will I get paid fairly?'\nUniWork has all the answers you need.\nSupporting Pai Chai Univ students in Korea.",
        btn_start: "Start Now",
        tab_check: "Inquiry/Calc",
        ...
        // F-Killer (Attendance Calculator)
        fk_title: "F-Killer",
        fk_subtitle: "How many absences left until F grade? (Pai Chai Exclusive)",
        fk_course_info: "📚 Course Information",
        fk_credits_label: "How many credits is this course?",
        fk_freq_label: "How many times per week?",
        fk_freq_note: "※ For 3-credit courses 2x/week, automatically calculated as 75min (1.5 hours).",
        fk_attendance_status: "📊 My Attendance Status",
        fk_absent_label: "Absences (missed entire class)",
        fk_late_label: "Late/Early leave count (3 = 1 absence)",
        fk_excused_label: "Excused absences count",
        fk_excused_note: "* Deducted from absences with supporting documents.",
        fk_rules_toggle: "[View Rules]",
        fk_rules_close: "[Hide Rules]",
        fk_calc_button: "💡 Calculate F Grade Risk",
        fk_disclaimer: "This calculator is based on university regulations.\nPlease cross-check with 'Hey Young' or 'Integrated Information System'.",
        fk_alert_select: "⚠️ Please select both credits and frequency!",
        fk_result_f_confirmed: "🚨 F Grade Confirmed (Retake Required)",
        fk_result_warning: "⚠️ Danger Zone! One more absence = F",
        fk_result_safe: "✅ Still Safe",
        fk_retake_rules: "ℹ️ Retake Course Rules",
    },
    jp: {
        landing_title: "培材大学で叶える\nあなたの夢",
        landing_desc: "「私のビザで働けるかな？」\n「給料はちゃんともらえるかな？」\n不安だったすべての疑問に、UniWorkがお答えします。\n培材大学留学生の皆さんの韓国生活を応援します。",
        btn_start: "始める",
        tab_check: "資格確認",
        tab_guide: "規定ガイド",
        tab_paperwork: "必要書類",
        ...
        // F-Killer (Attendance Calculator)
        fk_title: "F-Killer",
        fk_subtitle: "F単位まで何回残ってる？（培材大専用）",
        fk_course_info: "📚 授業情報",
        fk_credits_label: "この授業は何単位ですか？",
        fk_freq_label: "週何回ありますか？",
        fk_freq_note: "※ 3単位週2回選択時、自動で75分(1.5時間)で計算されます。",
        fk_attendance_status: "📊 私の出席状況",
        fk_absent_label: "欠席（授業全体を休んだ日）",
        fk_late_label: "遅刻・早退回数（3回 = 1回欠席）",
        fk_excused_label: "公欠・出席認定回数",
        fk_excused_note: "* 証明書類提出時、欠席から差し引かれます。",
        fk_rules_toggle: "[規定を見る]",
        fk_rules_close: "[規定を閉じる]",
        fk_calc_button: "💡 F単位リスク計算",
        fk_disclaimer: "本計算機は学則施行細則に基づいて計算されます。\n必ず'ヘイヨン'または'統合情報システム'をクロスチェックしてください。",
        fk_alert_select: "⚠️ 単位と授業回数を全て選択してください！",
        fk_result_f_confirmed: "🚨 F単位確定（再履修必要）",
        fk_result_warning: "⚠️ 崖っぷち！これ以上欠席するとF",
        fk_result_safe: "✅ まだ安全です",
        fk_retake_rules: "ℹ️ 再履修関連規定",
        // Apps
        apps_title: "必須アプリ",
        apps_desc: "韓国生活の必需品",
    ...
    ru: {
        ...
        // F-Killer (Attendance Calculator)
        fk_title: "F-Killer",
        fk_subtitle: "Сколько пропусков до оценки F? (Только для Pai Chai)",
        fk_course_info: "📚 Информация о курсе",
        fk_credits_label: "Сколько кредитов у этого курса?",
        fk_freq_label: "Сколько раз в неделю?",
        fk_freq_note: "※ Для 3-кредитных курсов 2 раза/нед автоматически считается как 75мин (1.5 часа).",
        fk_attendance_status: "📊 Моя посещаемость",
        fk_absent_label: "Пропуски (пропуск всего урока)",
        fk_late_label: "Опоздания/Ранний уход (3 = 1 пропуск)",
        fk_excused_label: "Уважительные пропуски",
        fk_excused_note: "* Вычитается из пропусков при предоставлении справки.",
        fk_rules_toggle: "[Посмотреть правила]",
        fk_rules_close: "[Скрыть правила]",
        fk_calc_button: "💡 Рассчитать риск оценки F",
        fk_disclaimer: "Этот калькулятор основан на уставе университета.\nОбязательно проверьте в 'Hey Young' или 'Integrated Information System'.",
        fk_alert_select: "⚠️ Пожалуйста, выберите кредиты и частоту!",
        fk_result_f_confirmed: "🚨 Оценка F подтверждена (Нужен пересдача)",
        fk_result_warning: "⚠️ Опасная зона! Еще один пропуск = F",
        fk_result_safe: "✅ Пока безопасно",
        fk_retake_rules: "ℹ️ Правила пересдачи курса",
        // Apps
        apps_title: "Важные приложения",
        apps_desc: "Жизнь в Корее",
        app_1_title: "1. KakaoTalk",
    ...
    cn: {
        ...
        // F-Killer (Attendance Calculator)
        fk_title: "F-Killer",
        fk_subtitle: "距离F学分还剩几次缺席？ (培材大专用)",
        fk_course_info: "📚 课程信息",
        fk_credits_label: "这门课程多少学分？",
        fk_freq_label: "一周几次课？",
        fk_freq_note: "※ 3学分周2次选择时，自动按75分钟(1.5学时)计算。",
        fk_attendance_status: "📊 我的出勤状况",
        fk_absent_label: "缺席（整堂课未到）",
        fk_late_label: "迟到/早退次数（3次 = 1次缺席）",
        fk_excused_label: "公假/出勤认定次数",
        fk_excused_note: "* 提交证明文件时从缺席中扣除。",
        fk_rules_toggle: "[查看规定]",
        fk_rules_close: "[收起规定]",
        fk_calc_button: "💡 计算F学分风险",
        fk_disclaimer: "本计算器基于学校规章制度计算。\n请务必与'Hey Young'或'综合信息系统'交叉确认。",
        fk_alert_select: "⚠️ 请选择学分和上课次数！",
        fk_result_f_confirmed: "🚨 F学分确定（需要重修）",
        fk_result_warning: "⚠️ 悬崖边缘！再缺席就是F",
        fk_result_safe: "✅ 还安全",
        fk_retake_rules: "ℹ️ 重修相关规定",
        // Apps
        apps_title: "必备APP",
        apps_desc: "韩国生活必需",
    ...
    vn: {
        ...
        ins_health_desc: "Chi trả viện phí",
        ins_health_auto: "Tự động gia nhập sau khi có ARC",
        ins_employment: "② Bảo hiểm thất nghiệp (고용보험)",
        ins_employment_desc: "Trợ cấp thất nghiệp (nếu đủ điều kiện)",
        ins_accident: "③ Bảo hiểm tai nạn lao động (산재보험)",
        ins_accident_desc: "Bồi thường chấn thương trong công việc",
        ins_pension: "④ Bảo hiểm hưu trí (국민연금)",
        ins_pension_desc: "Có thể hoàn trả khi về nước",
        tax_refund_title: "3. Hoàn thuế (Tháng 5)",
        tax_refund_when: "Thời gian báo cáo:",
        tax_refund_period: "Mỗi năm tháng 5 (Báo cáo thuế thu nhập tổng hợp)",
        tax_refund_tip: "* Nếu đóng thuế 3.3% có thể được hoàn! Truy cập Hometax (홈택스) hoặc hỏi văn phòng trường",
        tab_tax: "Thuế",

        // Work Permit Guide
        permit_title: "Cách xin phép làm việc",
        permit_subtitle: "Hoạt động ngoài tư cách lưu trú",
        permit_step1_title: "Kiểm tra điều kiện",
        permit_step1_a: "• D-2: GPA ≥ 2.0 + Cấp TOPIK",
        permit_step1_b: "• D-4: Cư trú ≥ 6 tháng + Tỷ lệ đi học ≥ 90%",
        permit_step2_title: "Giấy xác nhận trường",
        permit_step2_desc: "Đến Phòng Giao lưu Quốc tế xin 'Giấy xác nhận làm thêm'",
        permit_step3_title: "Đến Cục Xuất nhập cảnh",
        permit_step3_desc: "Hộ chiếu, ARC, Giấy xác nhận, Giấy phép KD, Hợp đồng lao động",
        permit_step4_title: "Chờ phê duyệt",
        permit_step4_desc: "Thời gian xử lý: ~1-2 tuần. Được đóng dấu trên ARC!",

        // Visa Travel
        travel_title: "Visa & Du lịch",
        travel_subtitle: "Nghỉ hè có về nước được không?",
        travel_expiry_title: "⛔ Chú ý hạn visa",
        travel_expiry_desc: "Phải xuất cảnh trước ngày hết hạn ghi trên mặt sau ARC.",
        travel_reentry_title: "Nhập cảnh lại (Nghỉ hè)",
        travel_reentry_1: "• Còn hạn + Ngày xuất cảnh = Có thể nhập cảnh lại",
        travel_reentry_2: "• Hết hạn visa = Không thể nhập cảnh với visa cũ (Cần xin mới)",

        // Trash
        trash_title: "Phân loại rác",
        trash_subtitle: "Cẩn thận bị phạt!",
        trash_general_title: "Rác thông thường",
        trash_general_desc: "Túi trắng định lượng (Mua ở cửa hàng tiện lợi)",
        trash_food_title: "Rác thức ăn",
        trash_food_desc: "Túi vàng (Không bỏ xương/vỏ!)",
        trash_recycle_title: "Rác tái chế",
        trash_recycle_desc: "Túi trong suốt (Lon, Chai, Nhựa)",

        // Korean Phrases
        phrases_title: "Cụm từ tiếng Hàn hữu ích",
        phrases_desc: "Tìm việc & đi làm",
        phrases_interview: "💼 Phỏng vấn",
        phrases_work: "🏪 Khi đi làm",
        phrases_problem: "⚠️ Khi có vấn đề",
        phrase_when_start: "Khi nào có thể bắt đầu làm?",
        phrase_schedule: "Lịch làm việc như thế nào?",
        phrase_understand: "Tôi hiểu rồi",
        phrase_help: "Có thể giúp tôi không?",
        phrase_payday: "Ngày trả lương là khi nào?",
        phrase_not_paid: "Tôi chưa được trả lương",
        phrase_too_many_hours: "Giờ làm việc quá nhiều",

        // Holiday Pay
        holiday_pay_label: "Phụ cấp nghỉ lễ (ước tính):",

        // F-Killer (Attendance Calculator)
        fk_title: "F-Killer",
        fk_subtitle: "Còn bao nhiêu lần vắng mặt trước khi bị điểm F? (Chuyên dụng Pai Chai)",
        fk_course_info: "📚 Thông tin môn học",
        fk_credits_label: "Môn này bao nhiêu tín chỉ?",
        fk_freq_label: "Một tuần học mấy buổi?",
        fk_freq_note: "※ Môn 3 tín chỉ tuần 2 buổi sẽ được tính tự động là 75 phút (1.5 tiết).",
        fk_attendance_status: "📊 Tình hình đi học của tôi",
        fk_absent_label: "Vắng mặt (nghỉ cả buổi học)",
        fk_late_label: "Số lần đi muộn/về sớm (3 lần = 1 lần vắng)",
        fk_excused_label: "Số lần vắng có phép/được công nhận",
        fk_excused_note: "* Sẽ được trừ khỏi số lần vắng khi có giấy tờ chứng minh.",
        fk_rules_toggle: "[Xem quy định]",
        fk_rules_close: "[Ẩn quy định]",
        fk_calc_button: "💡 Tính toán nguy cơ điểm F",
        fk_disclaimer: "Máy tính này dựa trên quy chế nhà trường.\nVui lòng kiểm tra chéo với 'Hey Young' hoặc 'Hệ thống thông tin tổng hợp'.",
        fk_alert_select: "⚠️ Vui lòng chọn cả tín chỉ và số buổi học!",
        fk_result_f_confirmed: "🚨 Xác định điểm F (Cần học lại)",
        fk_result_warning: "⚠️ Bên bờ vực! Vắng thêm lần nữa là điểm F",
        fk_result_safe: "✅ Vẫn an toàn",
        fk_retake_rules: "ℹ️ Quy định về học lại",
